/**
 * ConversationList — Left panel showing all WhatsApp conversations.
 *
 * Displays a searchable, filterable list of conversation contacts
 * with a "new outreach" button.
 */
